...
class CreateDwMediaMainCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dw_media_main_categories', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dw_media_main_categories');
    }
}
